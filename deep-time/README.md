...
Episode 01 of [Explorables](../README.md).
...
- `eras/01..16-*.html`, one page per era: a verdict, a generated scene image
 (prompts in `prompts.py`, generated by `../tools/gen_img.py`, files in
 `assets/scenes/hero,menu,kills/`), six
...
Then open `http://localhost:8000/deep-time/`. Opening `index.html` over `file://` also works
